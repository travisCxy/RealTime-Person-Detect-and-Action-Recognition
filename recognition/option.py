...
parser.add_argument('--num_classes', default=60, type=int, help='num of action class')
parser.add_argument('--input_size', default=448, type=int,help='size of input')
...
parser.add_argument('--model_path', default='..weights/best', type=str, help='path to pretrained model')

"------------------------------------ Data options ------------------------------------"
parser.add_argument('--datapath', default='../../dataset/SSD', help='path to dataset')
parser.add_argument('--listpath', default='data/list', help='path tot list directory')
